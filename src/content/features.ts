...
export const features: FeatureItem[] = [
  ...
  },
  {
    ...
    description: "Two teams, one goal: guess the word. The clue giver can't say the forbidden words—everyone else tries to guess before time runs out.",
    icon: Users,
  },
  {
    id: "observer",
    title: "Observer-friendly",
    description: "The other team watches the same card and can call out forbidden word violations. Fair, transparent, and more fun for everyone.",
    icon: Eye,
  },
  {
    id: "mobile",
